            ...
            <main className="flex-1 p-4 md:p-6 space-y-6">
                 <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="font-headline text-2xl font-extrabold tracking-tight sm:text-3xl animate-typing typing-effect overflow-hidden whitespace-nowrap bg-[linear-gradient(110deg,hsl(var(--primary)),45%,hsl(var(--accent)),55%,hsl(var(--primary)))] bg-[length:200%_100%] bg-clip-text text-transparent">
