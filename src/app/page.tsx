  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4 overflow-x-hidden">
      <div className="mb-8 flex w-full flex-col items-center text-center">
        <div className="mb-4 rounded-lg bg-primary/20 h-16 w-16 overflow-hidden flex items-center justify-center p-0">
        ...
        <div className="w-full overflow-hidden">
            <p className="animate-marquee-slow whitespace-nowrap">
              <span className="font-bold animate-shimmer bg-[linear-gradient(110deg,hsl(var(--primary)),45%,hsl(var(--accent)),55%,hsl(var(--primary)))] bg-[length:200%_100%] bg-clip-text text-transparent">Indahnya Tali Persaudaraan</span>
            </p>
        </div>
      </div>
